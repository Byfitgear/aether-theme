...
<div class="space-y-12">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class('border-b border-gray-100 pb-12 last:border-0'); ?>>
                <header>
                    <h2 class="text-2xl font-bold mb-2">
                        <a href="<?php the_permalink(); ?>" class="hover:text-gray-600 transition-colors">
                            <?php the_title(); ?>
                        </a>
                    </h2>
                ...
                <footer class="mt-4">
                    <a href="<?php the_permalink(); ?>" class="text-blue-600 hover:text-blue-800 transition-colors text-sm font-medium">
                        <?php _e('继续阅读', 'aether'); ?> →
                    </a>
                </footer>
            </article>
    ...
    <?php else: ?>
        <div class="text-center py-12">
            <h2 class="text-xl font-semibold text-gray-500"><?php _e('暂无内容', 'aether'); ?></h2>
            <p class="text-gray-400 mt-2"><?php _e('抱歉，未找到任何内容。', 'aether'); ?></p>
        </div>
    <?php endif; ?>
</div>
